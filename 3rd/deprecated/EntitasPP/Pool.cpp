...
namespace Chestnut {
namespace EntitasPP {
RefCountedPtr<Pool> Pool::Create() {
	RefCountedPtr<Pool> ptr(new Pool());
	return ptr;
}
...
auto Pool::CreateSystemRef(RefCountedPtr<ISystem> system)->RefCountedPtr<ISystem> {
	RefCountedPtr<ISystem> tmp = system;
