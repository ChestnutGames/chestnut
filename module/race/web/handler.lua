...
local function post_handler(code, path, method, query, ... )
	-- body
...
function _M.handle_post(code, path, header, body, ... )
	-- body
	return post_handler(code, path, "post", body)
end
...
function _M.handle_get(code, path, query, header, body, ... )
	-- body
	return post_handler(code, path, "get", query)
end
